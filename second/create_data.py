...
from second.data.my_dataset import create_my_groundtruth_database
...
def my_data_prep(root_path, train_path):
    create_my_groundtruth_database("MyDataset", root_path, train_path)
